...
export default function Icon({ size = 'small', className, name }: IconProps) {
  ...
  if (name === "cube") {
    ...
    return ( 
      ...
      >
        <path 
          fillRule="evenodd" 
          clipRule="evenodd" 
          d="M31.6486 6.42929C17.7215 6.42929 6.42929 17.7215 6.42929 31.6514C6.42929 45.5785 17.7215 56.8707 31.6486 56.8707C45.5785 56.8707 56.8707 45.5785 56.8707 31.6514C56.8707 30.4278 57.8617 29.4368 59.0854 29.4368C60.309 29.4368 61.3 30.4278 61.3 31.6514C61.3 48.0256 48.0235 61.3 31.6486 61.3C15.2737 61.3 2 48.0263 2 31.6514C2 15.2744 15.2737 2 31.6486 2C32.8722 2 33.8632 2.99103 33.8632 4.21464C33.8632 5.43826 32.8722 6.42929 31.6486 6.42929Z" 
          fill="currentColor"
        />
      </svg>
    );
    ...
    return ( 
      ...
      >
        <path 
          d="M28.1976 0.632812V49.1465L5.88327 26.8322L0.304688 32.5104L32.1823 64.388L64.0599 32.5104L58.4813 26.8322L36.167 49.1465V0.632812H28.1976Z" 
          fill="currentColor"
        />
      </svg>
    );
    ...
    return ( 
      ...
      >
        <path 
          d="M6.376 63.76L0 57.384L25.504 31.88L0 6.376L6.376 0L31.88 25.504L57.384 0L63.76 6.376L38.256 31.88L63.76 57.384L57.384 63.76L31.88 38.256L6.376 63.76Z" 
          fill="currentColor" 
        />
      </svg>
    );
    ...
    return ( 
      ...
      >
        <path 
          d="M30.0938 3.75L33.4219 7.07812L18 22.5L33.4219 37.9219L30.0937 41.25L11.3437 22.5L30.0938 3.75Z" 
          fill="currentColor" 
        />
      </svg>
    );
    ...
    return ( 
      ...
      >
        <path 
          d="M15.0469 41.25L11.7188 37.9219L27.1406 22.5L11.7188 7.07812L15.0469 3.75L33.7969 22.5L15.0469 41.25Z" 
          fill="currentColor" 
        />
      </svg>
    );
